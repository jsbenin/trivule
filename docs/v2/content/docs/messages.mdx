...
<input
    ...
    @v:messages="Le fichier est requis|Le fichier doit être un fichier texte"
    name="file"
/>
...
```html
<input type="email" name="email" @v:messages="{0}Please enter a valid email address|{1}Email must be at least 8 characters long">
```
