...
**Example:**
```html
<input data-tr-rules="min_length:8" /> 
```
or in JavaScript
```js
{
...
**Example:**
```html
<input data-tr-rules="max_length:8" /> 
```
or in JavaScript
```js
{
...
```html
<input data-tr-rules="string_between:8,20" />
```
...
**Example:**
```html
<input data-tr-rules="integer"/>
<!-- or -->
<input data-tr-rules="int"/>
```
...
**Example:**
```html
<input data-tr-rules="modulo:2"/>
<input data-tr-rules="mod:2"/>
``` 
...
**Example:**
```html
<input data-tr-rules="number_between:10,20"/>
```
...
**Example:**
```html
<input data-tr-rules="less_than:100"/>
<!-- Alias -->
<input data-tr-rules="lthan:100"/>
```
...
**Example:**
```html
<input data-tr-rules="greater_than:0"/>
<!-- Alias -->
<input data-tr-rules="gthan:0"/> 
```
## Dates
...
**Example:**
```html
<input type="date" data-tr-rules="date_between:2020-11-11,now" />
```
...
```html
<input data-tr-rules="max_file_size:1MB" />
``` 
...
```html
<input data-tr-rules="min_file_size:1MB" />
```
...
```html
<input data-tr-rules="file_between:1MB,5MB" />
```
...
```html
<input type="text" data-tr-rules="min_digit:3" />
```
...
```html
<input type="text" data-tr-rules="max_digit:10" />
```
...
```html
<input type="text" data-tr-rules="start_with_string:prefix" />
```
...
```html
<input type="text" data-tr-rules="end_with_string:suffix" />
``` 
